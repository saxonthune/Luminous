...
See `doc02.06.01` (Solid Migration ADR) for the concrete migration plan. This research session provides the strategic rationale: Solid is not just a performance upgrade — it's an architectural alignment with Luminous's core mission of making software artifacts legible to both humans and machines.
