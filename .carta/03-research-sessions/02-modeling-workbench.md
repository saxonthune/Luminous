...
deps: [doc01.01, doc02.01, doc02.02]
---
...
Jackson's concept-driven design (doc02.02) works well for user-facing behavior. "Upvote" has a purpose, actions, a lifecycle. "Trash" has an operational principle. These are real behavioral concepts.
...
**Resolution:** Use concepts for Luminous itself (the tool's behavior). Use modeling formalisms for what users create with the tool (the content). These are different levels. The concept inventory (doc02.02) describes how Luminous works. The modeling formalisms are what users build *on* Luminous.
...
The existing milestones (doc02.01) still hold. What changes is how they're framed:
...
The vision doc (doc01.01) says: "Luminous bridges human visual thinking and AI structured context." That's still true. The fuller picture:
