...
| doc02.06.01 | ADR: React to Solid.js Migration | doc | Architecture decision record for migrating Luminous client and cactus from React to Solid.js | adr, architecture, solid, react, performance, reactivity |
