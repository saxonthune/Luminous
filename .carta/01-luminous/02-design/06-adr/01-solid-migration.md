...
Remove `document`, `geometry`, `schema`, `server`, `vscode`, `web-client` from the workspace. These carry schema-first assumptions superseded by the unfolding architecture (doc01.02.01). No active packages depend on them.
...
- Cactus engine contract: doc01.02.05
- Unfolding architecture PDR: doc01.02.01
