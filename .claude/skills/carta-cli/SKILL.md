...
carta portable
```
Dump editable Python scripts into the workspace. Updates the scripts in `.carta/_scripts/` so collaborators can use `python3 .carta/carta.py <command>` without pip.
