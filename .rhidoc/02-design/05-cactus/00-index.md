...
| doc02.05.03 | Layout Primitives | doc | The layout algorithms cactus ships for trees, DAGs, containment, flat spacing, and overlap removal | cactus, layout, algorithms |
...
| doc02.05.06 | Clusters | doc | The cluster — cactus's envelope over a member set — its declaration API, the laminar and annotation tiers, and how nesting decomposes into cluster plus coordinate ownership | cactus, clusters, groups, layout, underlay |

Topics: algorithms, api, architecture, cactus, canvas, clusters, components, contract, css, engine, groups, hooks, layout, overview, theming, types, underlay
