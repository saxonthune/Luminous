...
See doc02.01 for architectural decisions. See doc01.01 for the vision these concepts serve.
...
Universal: any node can contain children, any node can be nested. Nesting survives formalization unchanged (doc02.01, D7) — when a parent is formalized, children stay as-is.
...
Schema-Pair Description synchronizes Edge and Schema. It makes edge meaning emergent rather than pre-declared. The three-polarity port system (in/out/neutral) remains available for domains that need fine-grained connection typing (doc02.01, D1, D3).
...
*Research session doc03.02 explores this in depth.*
